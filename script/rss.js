...
async function Rss() {
  ...
  const feed = new Feed({
    ...
    id: process.env.VERCEL_URL ? `https://${process.env.VERCEL_URL}` : 'https://tgsnake.js.org',
    link: process.env.VERCEL_URL ? `https://${process.env.VERCEL_URL}` : 'https://tgsnake.js.org',
    language: 'en',
    image: 'https://tgsnake.js.org/images/tgsnake.jpg',
    copyright: `MIT ${new Date().getFullYear()} © butthx.`,
    feedLinks: {
      json: path.join(
        process.env.VERCEL_URL ? `https://${process.env.VERCEL_URL}` : 'https://tgsnake.js.org',
        'rss/feed.json'
      ),
      atom: path.join(
        process.env.VERCEL_URL ? `https://${process.env.VERCEL_URL}` : 'https://tgsnake.js.org',
